...
func registerEnrich(r chi.Router, store *library.Store, enricher *enrich.Enricher) {
	...
	r.With(RequireAuth(store), RequireAdmin).Post("/api/admin/enrich-all", func(w http.ResponseWriter, req *http.Request) {
